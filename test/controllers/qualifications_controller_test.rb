...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { date_cal: @qualification.date_cal, user_id: @qualification.user_id, value_cal: @qualification.value_cal } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { date_cal: @qualification.date_cal, user_id: @qualification.user_id, value_cal: @qualification.value_cal } }
